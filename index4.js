...
const fs = require('fs');
var someObject = require('./sub-category/hardware.json');
...
function updatePageIndex(start) {
    ...
    var final = start1[0]+"?"+"p=2&product_list_limit=100";
    obj.push(final);
    // var start = "https://www.supplyvan.com/safety.html";
    let data = JSON.stringify(obj, null, 2);
    fs.writeFile('student-c61.json', data, (err) => {
      if (err) throw err;
    ...
    //     // console.log("obj",obj);
    //     let data = JSON.stringify(obj, null, 2);
    //     fs.writeFile('student-c6.json', data, (err) => {
    //       if (err) throw err;
    //       console.log('Data written to file');
    //     });
    // })).catch(errors => {
